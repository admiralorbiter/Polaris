...
from flask_app.models import Organization, User, UserOrganization, Role, db
...
class TestOrganizationContextMiddleware:
    ...
    def test_auto_select_single_organization(self, client, test_user, test_organization, test_role, app):
    ...
    def test_handles_inactive_organization(self, client, test_user, test_organization_inactive, app):
