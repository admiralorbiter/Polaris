...
class TestErrorAlertingSystem:
    ...
    def test_send_email_alert_missing_config(self, app):
        ...
        app.config.update({"ENABLE_EMAIL_ALERTS": True, "MAIL_SERVER": None, "MAIL_USERNAME": None})
    ...
    def test_send_slack_alert_missing_webhook(self, app):
        ...
        app.config.update({"ENABLE_SLACK_ALERTS": True, "SLACK_WEBHOOK_URL": None})
    ...
    def test_send_slack_alert_success(self, app):
        ...
        app.config.update(
            {"ENABLE_SLACK_ALERTS": True, "SLACK_WEBHOOK_URL": "https://hooks.slack.com/test"}
        )
    ...
    def test_send_webhook_alert_missing_url(self, app):
        ...
        app.config.update({"ENABLE_WEBHOOK_ALERTS": True, "WEBHOOK_URL": None})
