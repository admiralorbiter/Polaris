...
from flask_app.models import (
    db, Role, Permission, RolePermission, OrganizationFeatureFlag, SystemFeatureFlag, Organization
)
...
def create_default_permissions():
    ...
    permissions = [
        ...
        {'name': 'create_volunteers', 'display_name': 'Create Volunteers', 'category': 'volunteer_management'},
        {'name': 'edit_volunteers', 'display_name': 'Edit Volunteers', 'category': 'volunteer_management'},
        {'name': 'delete_volunteers', 'display_name': 'Delete Volunteers', 'category': 'volunteer_management'},
        {'name': 'view_volunteers', 'display_name': 'View Volunteers', 'category': 'volunteer_management'},
        
        # Organization Management
        {'name': 'manage_organization', 'display_name': 'Manage Organization', 'category': 'organization_management'},
        {'name': 'view_organization_settings', 'display_name': 'View Organization Settings', 'category': 'organization_management'},
...
def assign_permissions_to_roles(roles, permissions):
    ...
    org_admin_perms = [
        ...
        'create_volunteers', 'edit_volunteers', 'delete_volunteers', 'view_volunteers',
        'manage_organization', 'view_organization_settings',
    ...
    coordinator_perms = [
        'create_volunteers', 'edit_volunteers', 'view_volunteers',
...
def create_default_feature_flags():
    ...
    system_flags = [
        {'flag_name': 'maintenance_mode', 'value': False, 'flag_type': 'boolean', 'description': 'System-wide maintenance mode'},
        {'flag_name': 'registration_enabled', 'value': True, 'flag_type': 'boolean', 'description': 'Allow new user registration'},
    ]
