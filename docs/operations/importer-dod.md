...
- ✅ Survivorship precedence scenarios (manual wins, incoming overrides) covered with automated tests or documented golden dataset updates.
...
- ✅ Survivorship telemetry (`importer_survivorship_decisions_total`, `counts_json.core.volunteers.survivorship`) reviewed in dev/staging.
