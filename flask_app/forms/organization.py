...
class CreateOrganizationForm(FlaskForm):
    ...
    name = StringField(
        ...
        validators=[
            ...
            Length(
                min=2, max=200, message="Organization name must be between 2 and 200 characters."
            ),
        ],
    ...
    description = TextAreaField(
        "Description",
        validators=[
            optional_length(max=1000, message="Description must be less than 1000 characters.")
        ],
