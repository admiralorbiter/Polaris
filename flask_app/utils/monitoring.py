...
class HealthChecker:
    ...
    def detailed_health_check(self):
        ...
        if HAS_PSUTIL:
            ...
            try:
                ...
                health_data["checks"]["disk_space"] = {"status": "unhealthy", "error": str(e)}
                overall_healthy = False
            ...
            try:
                ...
                health_data["checks"]["cpu"] = {"status": "unhealthy", "error": str(e)}
                overall_healthy = False
        else:
        ...
        try:
            ...
            health_data["checks"]["application"] = {"status": "unhealthy", "error": str(e)}
            overall_healthy = False
    ...
    def readiness_check(self):
        ...
        try:
            ...
            return (
                jsonify({"status": "ready", "timestamp": datetime.now(timezone.utc).isoformat()}),
                200,
            )
