...
def register_api_routes(app):
    ...
    def api_search_organizations():
        ...
        try:
            ...
            current_app.logger.info(f"Organization search API called with query: '{query}' by user: {current_user.username}")
    ...
    def api_create_organization():
        ...
        try:
            ...
            try:
                ...
                current_app.logger.error(f"Unexpected error in api_create_organization: {str(e)}", exc_info=True)
                return jsonify({
                    'success': False,
            ...
            current_app.logger.info(f"Created new organization via API: {new_org.name} (ID: {new_org.id})")
