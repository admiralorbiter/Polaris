...
class AdminLog(BaseModel):
    ...
    )  # CREATE_USER, UPDATE_USER, DELETE_USER, etc.
    ...
    @staticmethod
    def log_action(
        admin_user_id, action, target_user_id=None, details=None, ip_address=None, user_agent=None
    ):
        """Log an admin action"""
        try:
            log_entry = AdminLog(
        ...
        try:
            ...
            if metric:
                ...
                metric = SystemMetrics(
                    metric_name=metric_name, metric_value=value, metric_data=data
                )
