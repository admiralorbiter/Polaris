...
from flask_app.utils.permissions import set_current_organization, get_user_organizations
    ...
    def set_organization_context():
        ...
        if organization:
            ...
            if not organization.is_active:
                current_app.logger.warning(f"Attempted access to inactive organization: {organization.id}")
                organization = None
            else:
